...
$subjectText = "群馬イノベーションアワード2015";
$subject = mb_encode_mimeheader($subjectText);
...
$body .= "\n" . "\n" . PHP_EOL;
$body .= $name . "様" . "\n" . PHP_EOL;
$body .= "この度は申し込みをいただきまして, 誠にありがとうございます。" . "\n" . PHP_EOL;
...
if(send_mail($to, $from, $subject, $body, $cc = null, $bcc = null, $filename)) {
    echo "";
} else {
    echo "自動送信メール失敗しました";
}
